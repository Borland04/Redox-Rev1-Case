...
This case is built for a **Wireless** Rev1 with use of [Nice!Nano V2](https://nicekeyboards.com/nice-nano/) MCU (Or its analogs. In my case - [ProMicro NRF52840](https://www.elecrow.com/pro-micro-nrf52840-development-board-compatible-with-nice-nano-v2-0.html)).
...
| -------------------------------------------------------------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| LiPol 3.7V Battery 403040 (500 mAh) <br>![[battery.jpg]]       | 2                       |                                                                                                                                                                                                        |
| JST-XH PH 1,25 2-pin connectors<br>![[jst_connector.jpg]]      | 2 pairs                 | Used to connect batteries to a PCBs<br><br>Part of a `PCB Prerequisites`                                                                                                                               |
| Micro Slide Switch Spdt SS12F15<br>![[power_switch.jpg]]       | 2                       | [AliExpress](https://aliexpress.ru/item/1005003938856402.html?sku_id=12000027515454290)<br><br>Part of a `PCB Prerequisites`                                                                           |
| MCU Hot-Swap Female connector<br>![[mcu_connector_female.jpg]] | 48 pins                 | [Amazon](https://www.amazon.in/Single-Headers-Machine-Female-2-54mm/dp/B0187LTEX2)<br><br>Part of a `PCB Prerequisites`                                                                                |
| RGB 4-pin Male connector<br>![[mcu_connector_male.jpg]]        | 24 pins                 | [AliExpress](https://aliexpress.ru/item/1005006655092258.html?gatewayAdapt=glo2rus&sku_id=12000037934700782)<br>Remove plastic holder, cut each pin in two halves<br><br>Part of a `PCB Prerequisites` |
| M3x8 Screw<br>![[m3_screw.jpg]]                                | 12                      | Used in a tight space. Use Hex or Phillips screws. DO NOT USE screws made for a wrench.                                                                                                                |
| M3x2.5 Nut                                                     | 12 (14 with Wrist Rest) |                                                                                                                                                                                                        |
| M3x16 Screw<br>![[m3_screw_long.jpg]]                          | 0 (2 with Wrist Rest)   | Used only in a Wrist Rest                                                                                                                                                                              |
...
* I also made a Nice!Nano MCU hot-swappable. ![[mcu_hotswap.jpg]]

* Solder 2-pin battery connector with power switch, breaking a `+` wire. ![[power_1.jpg]]
	* `-` wire should be soldered to a `ground` (or `Battery-` if you prefer). I choose this convenient place: ![[power_2.jpg]]
	* `+` wire should be soldered to a `Raw` (or `Battery+` if you prefer) pin of MCU: ![[power_3.jpg]]

* Solder 2-pin connector to a batteries: ![[battery_with_pins.jpg]]
...
> <details><summary>Pics</summary> ![[asymmetrical_usb.jpg]] ![[deformed_usb_case.jpg]]</details>

Print **one** `Bottom.stl`.
Print **one** `Reset_button.stl`

* Use drop of a Hot Glue to fix the battery in place. *Position is not important, I just prefer it at the outer side.* ![[battery_with_pins.jpg]]
* Put `M3 Screws` in a tenting base. Fill remaining space with a hot glue. *Using hot glue is highly recommended - otherwise you'll have hard times putting knobs on that screw.* ![[tent_screws.jpg]] ![[tent_screws_hotglued.jpg]]

* Put `Reset button` in according slot. ![[reset_button.jpg]]

* Put the `Power Switch`, which is a part of the PCB, in according slot. Fix it using `two M2 screws` and `two M2 nuts`. ![[power_switch_fixed.jpg]] ![[power_switch_fixed_front.jpg]]

* Connect battery to a PCB.
* Place the PCB. ![[pcb_in_case.jpg]]
...
* Place `Top` on top of a PCB, closing the case. ![[case_with_top.jpg]]
...
* Take `Tent_legs` and place them accordingly. Fix them using `Tent_knobs`. ![[tenting_kit_assembled.jpg]]
...
![[wristrest_slicer.jpg]]

* Put `one M3 Nut` in a nut slot.
* Take `one Long M3 Screw` and screw it. ![[wristrest_printed.jpg]]

* Slide `Wristrest` into the `Wristrest base`. To fix the Wristrest, twist the screw to the end. ![[wristrest_final.jpg]]

---
#### Final touches

* Glue silicon pads in according slots ![[case_final_bottom.jpg]]
## Contributions
